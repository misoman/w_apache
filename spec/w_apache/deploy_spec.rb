...
describe 'w_apache::deploy' do
	context 'with default setting' do
	  ...
	  before do
	    ...
	    stub_data_bag_item("w_apache", "jenkinskey").and_return('id' => 'jenkinskey', 'public_key' => 'ssh-rsa  jenkins@jenkins.examplewebsite.com')
		end
	  ...
	  it 'creates /root/.ssh/authorized_keys' do
	    expect(chef_run).to create_file('/root/.ssh/authorized_keys').with(owner: 'root', group: 'root', content: 'ssh-rsa  jenkins@jenkins.examplewebsite.com')
	  end
